...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
float pid_p_gain_roll = 1.3;               //Gain setting for the roll P-controller - def 1.3
float pid_i_gain_roll = 0.04;              //Gain setting for the roll I-controller - def 0.04
...
void setup(){
  ...
  internal_lamp_complete_blink(3);
}
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//Main program loop
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void loop(){
  ...
  gyro_pitch_input = (gyro_pitch_input * 0.7) + ((gyro_pitch / 65.5) * 0.3);//Gyro pid input is deg/sec. def (gyro_pitch_input * 0.7) + ((gyro_pitch / 65.5) * 0.3);
  gyro_yaw_input = (gyro_yaw_input * 0.3) + ((gyro_yaw / 65.5) * 0.3);      //Gyro pid input is deg/sec.
  ...
  if(micros() - loop_timer > 4050){
    internal_lamp_complete_blink(3);                                         // Blink the LED 3 times if the loop time exceeds 4050us.
  }
...
void internal_lamp_complete_blink(int led_setup){
  digitalWrite(LED_BUILTIN, LOW);
  delay(500);
  for (led_cycle = 0; led_cycle < led_setup; led_cycle ++) {
    digitalWrite(LED_BUILTIN, HIGH);
    delay(500);
    digitalWrite(LED_BUILTIN, LOW);
    delay(500);
