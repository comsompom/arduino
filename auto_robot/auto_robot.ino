...
/**
 * Tests the motors by moving them forward and backward.
 */
void testMotors() {
  ...
  Serial.println("Testing motors turn right...");
  setMotorSpeed(TURN_SPEED, -TURN_SPEED);
  delay(1000); // Turn for 1 second
  stopMotors();
  delay(1000); // Pause for 1 second

  Serial.println("Testing motors turn left...");
  setMotorSpeed(-TURN_SPEED, TURN_SPEED);
  delay(1000); // Turn for 1 second
  stopMotors();
  delay(1000); // Pause for 1 second
...
void printMotorShieldInfo() {
  ...
  Serial.print(", ENA=");
  Serial.println(LEFT_MOTOR_ENA);
  Serial.print("  Right Motor: IN3=");
  Serial.print(RIGHT_MOTOR_IN3);
  Serial.print(", IN4=");
  Serial.print(RIGHT_MOTOR_IN4);
  Serial.print(", ENB=");
  Serial.println(RIGHT_MOTOR_ENB);
  Serial.println("=====================================\n");
}
